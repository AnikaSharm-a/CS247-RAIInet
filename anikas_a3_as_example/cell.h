...
class Cell {
 ...
 public:
  ...
  void setState(int change);         //setter for private state
  void setCoords(int r, int c);		    //setter for private co-ordinates of cell
  ...
  void notify(int change);
	 ...
	 */
  void notify(int current, int previous);
};
#endif
